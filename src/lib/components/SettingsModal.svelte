...
<style>
  ...
  main{min-width:0;overflow:auto;padding:38px 42px 48px;background:radial-gradient(circle at 90% 0,#a7b66609,transparent 33%)}.heading{display:flex;align-items:flex-start;justify-content:space-between;gap:28px;padding-bottom:23px;border-bottom:1px solid var(--border)}.eyebrow{display:block;margin-bottom:7px;font-size:9px;font-weight:750;letter-spacing:.15em;text-transform:uppercase;color:var(--accent)}h2{margin:0;font-size:25px;letter-spacing:-.035em}h3{margin:0}.heading p{max-width:550px;margin:8px 0 0;font-size:12px;line-height:1.55;color:var(--muted)}button{font-family:inherit}.secondary,.primary,.choose{height:32px;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:0 10px;border:1px solid var(--border-strong);border-radius:7px;background:var(--surface);color:var(--muted);font-size:10px;cursor:pointer;white-space:nowrap}.secondary:hover,.choose:hover{border-color:#a7b66655;color:var(--text)}button:disabled{opacity:.45;cursor:not-allowed}.primary{border-color:var(--accent);background:var(--accent);color:#171912;font-weight:700}:global(.spin){animation:spin .9s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}
